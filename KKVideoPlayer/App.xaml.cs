namespace KKVideoPlayer
{
    ...
    public partial class App
    {
        ...
        public App()
        {
            ...
            Library.FFmpegDirectory = @"E:\Projects\CustomVideoPlayer\ffmpeg" + (Environment.Is64BitProcess ? @"\x64" : string.Empty);
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            Current.MainWindow.Closing += (snd, eva) => ViewModel.OnApplicationClosed();
